  ...
  <div class="mobileNav__wrapper">
    <ul class="flex">
      <li
        ...
        :key="key"
        :class="['cursor-pointer flex justify-center items-center column', { 'active' : item.active }]"
...
<script lang="ts" setup>
  ...
  const mobileNav: Ref<MenuNavInterface[]> = ref([
    ...
    { active: false, label: 'Search', notifications: 0, icon: 'search', link: '' },
    { active: false, label: 'Coming Soon', notifications: 7, icon: 'video_library', link: '' },
    { active: false, label: 'Downloads', notifications: 0, icon: 'download', link: '' },
